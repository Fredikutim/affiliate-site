...
DEFAULT = {"hero": {"title": "Solusi Investasi, Crypto & Bisnis", "highlight": "Modern & Terpercaya", "subtitle": "Kumpulan link afiliasi pilihan FREDI SUSANTO BENGALON KUTIM untuk investasi, crypto, belanja, travel, teknologi, dan keuangan digital."}, "sections": [
    ...
    {"id": "crypto", "icon": "₿", "title": "Crypto & Aset Digital", "desc": "Dunia kripto dan trading dalam genggaman",
     "links": [{"icon": "fas fa-money-bill-trend-up", "name": "BtcDana", "desc": "Mulai perjalanan menuju kekayaan! Kode undangan: AMBILBONUS", "url": "https://reg.btcdana.org/fx/indonesia/btcDana/activity_collection/register?data=eyJpbnZpdGVJZCI6IkFNQklMQk9OVVMiLCJhY3Rpdml0eUlkIjoiIiwidXNlclNvdXJjZSI6IiJ9"}]},
    {"id": "forex", "icon": "💹", "title": "Forex & Trading", "desc": "Trading forex, crypto, dan investasi dalam satu tempat",
     "links": [{"icon": "fas fa-rocket", "name": "Quick Pro", "desc": "Download Quick Pro now! Platform trading forex paling canggih", "url": "https://quickpro.go.link/i9bAl"},
               {"icon": "fas fa-globe", "name": "Binance", "desc": "Kode referral: CPA_005KZ21YMN. Exchange crypto & trading global terbesar!", "url": "https://www.bmwweb.biz/id/activity/referral-entry/CPA?ref=CPA_005KZ21YMN&utm_medium=web_share_copy"},
               {"icon": "fas fa-coins", "name": "Indodax", "desc": "Jual beli crypto terpercaya #1 di Indonesia. Daftar sekarang!", "url": "https://indodax.onelink.me/qyYY/referral?deep_link_value=page:register,id:fredisusanto"},

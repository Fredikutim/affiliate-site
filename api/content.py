...
DEFAULT = {"hero": {"title": "Solusi Investasi, Crypto & Bisnis", "highlight": "Modern & Terpercaya", "subtitle": "Kumpulan link afiliasi pilihan FREDI SUSANTO BENGALON KUTIM untuk investasi, crypto, belanja, travel, teknologi, dan keuangan digital."}, "sections": [
    ...
    {"id": "teknologi", "icon": "🤖", "title": "Teknologi & AI", "desc": "Inovasi digital untuk bisnis Anda",
     "links": [{"icon": "fas fa-brain", "name": "OpenRouter", "desc": "Akses berbagai model AI gratis & berbayar", "url": "https://openrouter.ai"},
               {"icon": "fas fa-microchip", "name": "AI (Artificial Intelligence) Machine", "desc": "ChatGPT, GPT-4, DALL-E & lainnya", "url": "#"},
               ...
               {"icon": "fas fa-server", "name": "Niagahoster", "desc": "Hosting terbaik untuk website Anda", "url": "#", "subs": [{"icon": "fas fa-link", "name": "Sisteme", "desc": "Buat Sistem Bisnis Digital Otomatis, 100% GRATIS! Pusing membayar langganan hosting, email marketing, dan website builder secara terpisah setiap bulan? Beralihlah ke platform all-in-one paling revolusioner! Tanpa perlu kartu kredit, paket Freemium (Rp 0/bulan) langsung memberikan Anda: Database hingga 2.000 kontak leads, 3 Saluran Penjualan (Sales Funnel), 1 Blog & 1 Kelas Online (Course), Toko pembuatan produk digital Anda sendiri! Hentikan pemborosan. Mulai bangun aset digital Anda tanpa risiko finansial hari ini. Daftar gratis sekarang!", "url": "https://fredisusanto.systeme.io/proxy/request/57710bb729c0d7cdcb6fd9804bca2761a603a"}]},
               {"icon": "fas fa-key", "name": "Genfity AI — Paket Sehari", "desc": "Khusus Paket sehari untuk OpenAI & Anthropic. Key: genfity_cb5ffbbb8207d3f34764e293d47d54f5a330fd09 — Ganti key setiap hari jika habis masa berlaku.", "url": "https://ai.genfity.com/v1"}]}
]}
